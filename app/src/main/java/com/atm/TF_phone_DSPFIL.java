...
public class TF_phone_DSPFIL extends AppCompatActivity {
	...
	private static final String TAG = TF_phone_DSPFIL.class.getSimpleName(); 
	...
	public TF_phone_DSPFIL() {
		...
		this.mHandler = new Handler() {
			...
			public void handleMessage( final Message msg ) {
				...
				com.atm.db.TF_phone_DAO.Registro reg = null;
				if ( msg.arg1 != ListView.INVALID_POSITION ) {
					if ( mLstAdpt!= null && ! mLstAdpt.isEmpty() ) {
						...
						if ( "Registro".equals( o.getClass().getSimpleName() ) ) {
							reg = (com.atm.db.TF_phone_DAO.Registro)o;
						}
					}
				}
				//////////////////////////
	...
	//				} } ).start();
				...
				case K.MSG_MNU_NUEVO_OK: 
					Log.i(TAG,"MSG_MNU_NUEVO()");
					startActivity( new Intent(mCtx,TF_phone_ADDRCD.class) );
					break;
	
				case K.MSG_MNU_EDITAR_OK: 
					Log.i(TAG,"MSG_MNU_EDITAR_OK() --> " + msg.arg1);
					if ( reg != null ) {
						Intent intent = new Intent(mCtx,TF_phone_EDTRCD.class);
						intent.putExtra ( "tf_reg", reg );
				...
				case K.MSG_MNU_SUPRIMIR_OK: 
					...
					if ( reg != null ) {
						...
						mDBHelper.tf_phone.dltObj(mDBHelper.mDB);
						mHandler.sendEmptyMessage( K.MSG_CARGANDO_ESPERE );
					}
					break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.tf_list);
		LayoutInflater inflater = (LayoutInflater) this.getSystemService( Context.LAYOUT_INFLATER_SERVICE ); 
		mViewLayout = inflater.inflate(R.layout.tf_list, null, false);
		...
		mLv_lista = (ListView) findViewById(R.id.tf_lv_lista);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		new MenuInflater( this ).inflate( R.menu.tf_menu, menu );
...
//	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		switch ( item.getItemId() ) {
			...
			case R.id.tf_mnu_refrescar: mHandler.sendEmptyMessage( K.MSG_MNU_REFRESCAR ); return true;

			case R.id.tf_mnu_nuevo: mHandler.sendEmptyMessage( K.MSG_MNU_NUEVO ); return true;
...
//		return super.onMenuItemSelected(featureId, item);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		new MenuInflater( this ).inflate( R.menu.tf_menu_ctx, menu);
	...
	private void cargarAdapters() {
		...
		mLstAdpt = null;
		mLstAdpt = mDBHelper.tf_phone.getAdapter(mDBHelper.mDB, mCtx, mHandler);
