...
public class US_Users_DSPFIL extends AppCompatActivity {
	...
	private static final String TAG = US_Users_DSPFIL.class.getSimpleName();
	...
	public US_Users_DSPFIL() {
		...
		this.mHandler = new Handler() {
			...
			public void handleMessage( final Message msg ) {
				...
				com.atm.db.US_Users_DAO.Registro reg = null;
				if ( msg.arg1 != ListView.INVALID_POSITION ) {
					if ( mLstAdpt!= null && ! mLstAdpt.isEmpty() ) {
						...
						if ( "Registro".equals( o.getClass().getSimpleName() ) ) {
							reg = (com.atm.db.US_Users_DAO.Registro)o;
						}
					}
				}
				//////////////////////////
				...
				switch ( msg.what ) {
					...
					case K.MSG_MNU_NUEVO_OK:
						Log.i(TAG,"MSG_MNU_NUEVO()");
						startActivity( new Intent(mCtx,US_Users_ADDRCD.class) );
						break;

					case K.MSG_MNU_EDITAR_OK:
						Log.i(TAG,"MSG_MNU_EDITAR_OK() --> " + msg.arg1);
						if ( reg != null ) {
							Intent intent = new Intent(mCtx,US_Users_EDTRCD.class);
					...
					case K.MSG_MNU_SUPRIMIR_OK:
						...
						if ( reg != null ) {
							...
							mDBHelper.us_Users.dltObj(mDBHelper.mDB);
							mHandler.sendEmptyMessage( K.MSG_CARGANDO_ESPERE );
						}
						break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.us_list);
		LayoutInflater inflater = (LayoutInflater) this.getSystemService( Context.LAYOUT_INFLATER_SERVICE );
		mViewLayout = inflater.inflate(R.layout.us_list, null, false);
		...
		mLv_lista = (ListView) findViewById(R.id.us_lv_lista);

		// Menú contextual para cada item de la lista
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		new MenuInflater( this ).inflate( R.menu.us_menu, menu );
...
//	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		switch ( item.getItemId() ) {
			...
			case R.id.us_mnu_refrescar: mHandler.sendEmptyMessage( K.MSG_MNU_REFRESCAR ); return true;

			case R.id.us_mnu_nuevo: mHandler.sendEmptyMessage( K.MSG_MNU_NUEVO ); return true;
...
//		return super.onMenuItemSelected(featureId, item);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		new MenuInflater( this ).inflate( R.menu.us_menu_ctx, menu);
	...
	private void cargarAdapters() {
		...
		mLstAdpt = null;
		mLstAdpt = mDBHelper.us_Users.getAdapter(mDBHelper.mDB, mCtx, mHandler);
		if ( mDBHelper.us_Users.mRegistros.isEmpty() ) {
			mLstAdpt = null;
